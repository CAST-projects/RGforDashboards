...
namespace CastReporting.Repositories.Interfaces
{
    ...
    public interface ICastRepsitory : IDisposable
    {
        ...
        /// </summary>
        /// <returns></returns>
        IEnumerable<Result> GetResultsQualityStandardsRules(string hRef, string stgTagParam, string modulesParam, string technologiesParam, bool evolutionSummary);
        ...
        IEnumerable<StandardTag> GetQualityStandardsTagsApplicabilityByCategory(string domain, string category);
        ...
        IEnumerable<Violation> GetRemovedViolations(string snapshotHRef, string businessCriteria, int count, string criticity);
